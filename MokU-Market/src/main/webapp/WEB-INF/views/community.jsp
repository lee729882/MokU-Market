...
<head>
    ...
    <style>
        ...
        * {
        ...
        .post-content-area { padding: 0 16px 12px; }
        ...
        .comment-delete:hover { color: #ed4956; }
        ...
        @media (max-width: 640px) {
            .write-btn { right: 20px; }
            .container { padding: 80px 12px 60px; }
        }
    </style>
</head>
<body>
...
<button class="write-btn" onclick="toggleWriteForm()">
    <svg viewBox="0 0 24 24">
        <path d="M12 4v16m8-8H4" stroke="#fff" stroke-width="2" stroke-linecap="round" fill="none"/>
    </svg>
</button>
...
<div class="modal-overlay" id="modalOverlay">
    <div id="writeForm">
        <div class="form-header">
            <button class="close-btn" onclick="toggleWriteForm()">&times;</button>
            <h3>새 게시물</h3>
...
<nav class="bottom-nav">
    <svg class="nav-icon" viewBox="0 0 24 24">
        <path d="M9.005 16.545a2.997 2.997 0 012.997-2.997h0A2.997 2.997 0 0115 16.545V22h7V11.543L12 2 2 11.543V22h7.005z" fill="none" stroke="currentColor" stroke-width="2"/>
    </svg>
    <svg class="nav-icon" viewBox="0 0 24 24">
    ...
    <svg class="nav-icon" viewBox="0 0 24 24">
        ...
        <path d="M6.168 18.849A4 4 0 0110 16h4a4 4 0 013.834 2.855" fill="none" stroke="currentColor" stroke-width="2"/>
    </svg>
</nav>
...
async function submitPost() {
    ...
    fd.append("writerName", writerName);
